...
CExpressionScanner::CExpressionScanner() :
	m_pFileMem(NULL)
{
...
// 
//----------------------------------------------------------------------------
BOOL CExpressionScanner::LoadFile( const char *szFileName, BOOL bTrace ) // bTrace=FALSE
{
	OFSTRUCT of;
...
//----------------------------------------------------------------------------
BOOL CExpressionScanner::LoadPackageFile( BYTE *pFileMem, int nFileSize )
{
	if (m_pFileMem)
		delete[] m_pFileMem;
...
Tokentype CExpressionScanner::GetToken()
{
...
Tokentype CExpressionScanner::GetTokenQ( int nIdx )
{
	if (!m_pFileMem) return ENDFILE;
...
char* CExpressionScanner::GetTokenStringQ( int nIdx )
{
...
char* CExpressionScanner::CopyTokenStringQ( int nIdx )
{
	if (!m_pFileMem) return NULL;
...
char CExpressionScanner::GetNextChar()
{
...
//----------------------------------------------------------------------------
BOOL CExpressionScanner::GetString(char *receiveBuffer, int maxBufferLength)
{
...
void CExpressionScanner::UngetNextChar()
{
	--m_nLinePos;
}


Tokentype CExpressionScanner::_GetToken( char *pToken )
{
	BOOL bFloat = FALSE;
